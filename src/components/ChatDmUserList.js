  ...
  console.log(users);
    ...
    return (
      ...
      sendRequest={props.sendRequest} getAllUsersList={props.getAllUsersList} />
       { !isOpen ? <i  id="DmArrow" className="arrow fas fa-chevron-down"></i> :
       <i id="DmArrow" className="arrow fas fa-chevron-up"></i>}
            
    </Button>
      <Collapse isOpen={isOpen}  style={{overflowY:'hidden' }}> 
