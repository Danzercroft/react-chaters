    ...
    <div style={{marginLeft:"auto"}}>
      ...
      <Modal placement="bottom" isOpen={modalOpen} toggle={toggle} className="channelDetailsModal">
        ...
        <ModalBody style={{fontSize:"1rem"}}>
          ...
          <h3>Owner</h3>
          { props.channel.id === 1 ? 
            <p>  <img className="dmAvatar" src={"assets/images/SYSTEM.jpg"}/> <b>SYSTEM</b> </p> : 
            <p> <img className="dmAvatar" src={"storage/"+props.channel.owner_avatar}/><b>{props.channel.owner}</b></p> }
